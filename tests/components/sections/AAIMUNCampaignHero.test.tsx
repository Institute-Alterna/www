...
describe("AAIMUNCampaignHero", () => {
  ...
  it("links the announcement to the first /mun section in home variant", () => {
    render(<AAIMUNCampaignHero variant="home" />);
    expect(
      screen.getByText(/explore the announcement/i).closest("a")
    ).toHaveAttribute("href", "/mun#conference");
  });
